...
datatsetPath = 'dataset\GranadosECCV';
...
for iSeq = 1: length(videoDir)
    ...
    if(~exist(resVideoFileName, 'file') || ~exist(resHoleVideoFileName, 'file'))
        ...
        wInputVidObj = VideoWriter(resVideoFileName);
